...
function plotall(case::Int)
    ...
    elseif case == 2
        fn_Xs_b1 = "results_case_2/case_2_branch_1_new_new.dat"
        fn_Ps_b1 = "results_case_2/case_2_branch_1_new_new_P.dat"
        fn_Xs_b2 = "results_case_2/case_2_branch_2.dat"
        fn_Ps_b2 = "results_case_2/case_2_branch_2_P.dat"
        eps_c = [1.0; 1.5]
    else
        error("case not done")
    end
